...
public class OperatiiMatematice {
    ...
    public double adunarea(double number1, double number2){
    ...
    public double scaderea(double number1, double number2) {
        double num = number1 - number2;
        System.out.println("scaderea: " + number1 + " - " + number2 + " = " + num);
        return num;
    }
    ...
    public double inmultirea(double number1, double number2) {
        double num = number1 * number2;
        System.out.println("inmultirea: " + number1 + " * " + number2 + " = " + num);
        return num;
    }
    ...
    public int impartirea(int number1, int number2) {
        int num = number1 / number2;
        System.out.println("impartirea: " + number1 + " / " + number2 + " = " + num);
        return num;
    }
